...
namespace HotPot.HttpClient.Net45.Extension
{
    public static class HttpClientExtension
    {
        ...
        public static string TryGetString(this IHttpClient httpClient, string url, string outStr, object param = null, Dictionary<string, string> headers = null)
        {
            try
            {
